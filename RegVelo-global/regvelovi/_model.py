...
class REGVELOVI(VAEMixin, UnsupervisedTrainingMixin, BaseModelClass, RegVeloMixin):
    ...
    **model_kwargs
    ...
    def get_latent_time(
        ...
        if return_numpy is None or return_numpy is False:
            if velocity_mode == "global":
                ...
                return pd.DataFrame(
                    times,
                    columns=adata.var_names[self.module.readout_type == "spliced"][self.module.target_index],
                    index=adata.obs_names[indices],
                )
        else:
            return times
    ...
    def get_velocity(
        ...
        spliced = spliced[:,self.module.readout_type == "spliced"]
